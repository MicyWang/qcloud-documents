...
| ------------------ | ------------- | ------------------ | ------ | -------- | ------------ | ------------------------------------------------------------ |
| Codec                      | Request.Video | 编解码格式            | String | 否   |   H.264，当format为WebM时，为VP8 |  <li>H.264<br/><li> H.265<br/><li>VP8<br/><li>VP9                                      |
...
| Preset                     | Request.Video | 视频算法<br/>器预置        | String | 否   | medium，当Codec为VP8时，为good       | <li>H.264支持该参数，取值veryfast、fast、medium、slow、slower<br/><li>VP8支持该参数，取值good、realtime<br/><li>VP9不支持该参数  |
| Bufsize                    | Request.Video | 缓冲区<br/>大小            | String | 否   | 0           | <li>值范围：[1000，128000]<br/><li>单位：Kb<br/><li>默认值为0，表示不使用缓冲区<br/><li>Codec为VP8/VP9时不支持此参数  |
| Maxrate                    | Request.Video | 视频码率<br/>峰值          | String | 否   | 0           | <li>值范围：[10，50000]<br/><li>单位：Kbps<br/><li>默认值为0，表示不使用此参数<br/><li>Codec为VP8/VP9不支持此参数  |
| HlsTsTime                  | Request.Video | hls 分片<br/>时间           | String | 否   | 5            | <li>(0 视频时长] <br/><li>单位为秒<br/><li>Codec为VP8/VP9时不支持此参数 |
| Pixfmt                     | Request.Video | 视频颜色<br/>格式           | String | 否   | yuv420p           | <li>H.264支持：yuv420p、yuv422p、yuv444p、yuvj420p、yuvj422p、yuvj444p<br/><li>H.265支持：yuv420p<br/><li>Codec为VP8/VP9时不支持此参数 |
| LongShortMode              | Request.Video | 长短边自适应          | String | 否   | false        | <li>true、false<br/><li>Codec为VP8/VP9时不支持此参数 |
