...
-  API 方式：您可使用 API 接口创建视频转动图任务，使用详情请见 [ API 文档](https://cloud.tencent.com/document/product/460/76900)。

#### 删除、查询、搜索任务
您可使用 API 接口方式对任务进行 [删除](https://cloud.tencent.com/document/product/460/76942)、[查询](https://cloud.tencent.com/document/product/460/76947) 任务信息、[搜索](https://cloud.tencent.com/document/product/460/76944) 指定条件下的任务操作。
